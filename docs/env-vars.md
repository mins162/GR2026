...
| 변수 | 값 | 설명 |
| --- | --- | --- |
| `INSTANTGR_TREE_CENTER` | `cpu` | 호스트 측 정확한 tree-center 루트 선택 |
| `INSTANTGR_TREE_CENTER_MIN_DEGREE` | 기본 10 | tree-center 적용 최소 차수 |
| `INSTANTGR_GPU_TREE_CENTER` | `1` | GPU 측 근사 tree-center 루트 선택 |
...
| `INSTANTGR_AUGMENTED_DAG_PROFILE` | Stage 2 augmented-DAG 깊이 / 구간별 시간 출력 |
